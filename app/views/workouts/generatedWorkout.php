    ...
    <main>
        <section class="main-bubble">
            ...
            <div class="main-bubble__area main-bubble__area--button-area">
                ...
                <button id="generateAnotherBtn" class="list-area__button button-area__button button-area__button--new"> Generate another workout </button>
            </div>
        </section>
    </main>
    <?php
...
<script src="/project/public/javascript/workouts/generated.js"></script>
